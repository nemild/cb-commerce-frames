...
export const NEXT_PUBLIC_URL = 'https://cb-commerce-frames.vercel.app';
...
export const PRODUCT_PRICE_USD = '5.0';
export const ITEM_DESCRIPTION = 'Buy our dog another cupcake';
export const ITEM_TITLE = 'Cupcakes';
